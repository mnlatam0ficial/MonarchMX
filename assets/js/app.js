...
const SNEAKERS_DATA = [
    ...
    { id: "MNK-002", marca: "Nike", nombre: "Classic Cortez Leather", precio: "$1,400" },
    { id: "MNK-003", marca: "Jordan", nombre: "6 Rings", precio: "$2,000" },
    { id: "MNK-004", marca: "Jordan", nombre: "1 Mid Space Jam", precio: "$2,200" },
    { id: "MNK-005", marca: "Salvatore Ferragamo", nombre: "Blancos Suela Roja", precio: "$2,800" },
    ...
    { id: "MNK-017", marca: "Louis Vuitton", nombre: "LV Trainer Blanco y Negro", precio: "$2,800" },
    ...
    { id: "MNK-020", marca: "Nike", nombre: "Air Max 97 Negro/Azul/Blanco", precio: "$1,900" },
    ...
    { id: "MNK-024", marca: "Nike", nombre: "Total 90 3 SP Negro/Blanco", precio: "$1,900" },
    { id: "MNK-025", marca: "Nike", nombre: "Total 90 III Blanco/Dorado", precio: "$2,000" },
    { id: "MNK-026", marca: "Nike", nombre: "Air Max 720 Blanco/Negro Orca", precio: "$2,100" },
    { id: "MNK-027", marca: "Louis Vuitton", nombre: "LV Trainer Blanco", precio: "$2,700" },
    { id: "MNK-028", marca: "Alexander McQueen", nombre: "Graffiti Negro", precio: "$2,700" },
    { id: "MNK-029", marca: "Alexander McQueen", nombre: "Oversized", precio: "$3,000" },
    { id: "MNK-030", marca: "Alexander McQueen", nombre: "Oversized Black Crystal Glitter", precio: "$2,900" },
    { id: "MNK-031", marca: "Nike", nombre: "Air More Uptempo Low Blanco/Azul Hyper Royal", precio: "$2,200" },
    { id: "MNK-032", marca: "Nike", nombre: "Air Jordan 6 Retro SP Travis Scott Cactus Jack", precio: "$2,300" },
    ...
    { id: "MNK-036", marca: "Louis Vuitton", nombre: "LV Trainer Monograma Azul/Blanco", precio: "$2,800" },
